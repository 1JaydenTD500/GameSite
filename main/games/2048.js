...
(function () {
	...
	var Renderer = (function () {
		...
		var Renderer = {
			...
			showGameWon: function (canvas, context) {
				...
				context.font = "bold " + Metrics.getHeaderSize() + "px Viga";
			...
			showRestart: function (canvas, context) {
				...
				// Show the message
				context.font = "bold " + fontSize + "px Viga";
				context.textAlign = "center";
			...
			drawTile: function (context, grid, tile, coordinates, width, height) {
				...
				context.font = "bold " + Metrics.getTileSize(width, height) + "px Viga";
				context.textAlign = "center";
				context.textBaseline = "middle";
	...
	window.Application = (function () {
		...
		(function mainLoop() {
			...
			// Draw the scores
			document.getElementById('score').innerText = 'Score: ' + game.data.score;;
			...
			if (hasWon || hasLost) {
				...
				if (hasWon) Renderer.showGameWon(gameCanvas, gameContext);
				else Renderer.showGameOver(game.data.score);
			} else {
...
document.getElementById('but_back').addEventListener('click', () => {
